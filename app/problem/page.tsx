...
export default function ProblemPage() {
  return (
    <>
      ...
      <section className="relative bg-zinc-900 text-white border-y border-zinc-800" aria-label="Cost of hardware replacement">
        <div className="relative z-10 max-w-[80rem] mx-auto px-6 md:px-10 py-12 md:py-16">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <Reveal delay={180}>
              <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-light max-w-2xl">
          ...
          {/* Grid of four upgraded cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
            {COSTS.map(({ label, number, per, parts }, i) => {
              return (
                <Reveal key={label} delay={i * 80}>
                  <div className="border-t border-zinc-700 pt-6 flex flex-col justify-between h-full group hover:border-zinc-500 transition-colors duration-300">
                    <div>
                      {/* Label & Number */}
          ...
          {/* Upgraded Dashboard TCO Projection */}
          <div className="mt-20 pt-14 border-t border-zinc-850">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-4 flex flex-col justify-between">
                <Reveal>
                  <div>
                    <h3 className="font-display text-xl md:text-2xl text-white tracking-tight leading-snug mb-4">
                ...
                <Reveal delay={80}>
                  <div className="hidden lg:block pt-4 border-t border-zinc-700">
                    <p className="text-2xl font-display font-semibold text-emerald-400 mb-1">
                      88% Saved
                    </p>
              ...
              <div className="lg:col-span-8">
                <Reveal delay={120}>
                  <div className="p-6 md:p-8 rounded-xl border border-zinc-800 bg-zinc-950/20 relative overflow-hidden">
